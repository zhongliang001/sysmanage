...
public class UserRoleControllerTest {
    ...
    private final Logger logger = LoggerFactory.getLogger(UserRoleControllerTest.class);
    ...
    public void config() throws Exception{
        ...
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders
                .post("/userrole/config").contentType(MediaType.APPLICATION_JSON_VALUE).content(requestBody)
